...
const TermsOfUse = () => {
    ...
    const AppService: Array<BulletProps> = [
    ...
    const Agreements: Array<BulletProps> = [
    ...
    const Disclaimer: Array<BulletProps> = [
    ...
    const Restrictions: Array<BulletProps> = [
    ...
    return (
        <SafeAreaView style={Styles.container} edges={['bottom']}>
            <ScrollView style={Styles.scrollView}>
                ...
                <Text style={GlobalStyle.intro}>{`Welcome to ${APP_TITLE} (“the App”), operated by ${COMPANY_NAME} (“we,” “our,” or “us”).
...
If you do not agree to these Terms, do not use the App.`}</Text>
                ...
                <View style={GlobalStyle.sectionContainer}>
                    <Text style={GlobalStyle.section}>
                        <Text style={GlobalStyle.title}>Overview</Text>
                    ...
                    <Text style={GlobalStyle.section}>
                        The App is intended for general wellness and lifestyle purposes only. It is <Text style={GlobalStyle.highlight}>
                ...
                <View style={GlobalStyle.sectionContainer}>
                    <Text style={GlobalStyle.section}>
                        <Text style={GlobalStyle.title}>Eligibility</Text>
...
By using the App, you confirm that you meet this age requirement and agree to comply with all applicable laws and regulations.`}
                ...
                <View style={GlobalStyle.sectionContainer}>
                    <Text style={GlobalStyle.section}>
                        <Text style={GlobalStyle.title}>User Accounts</Text>
                        {`\n\nTo access certain features, you may need to create an account.\nYou agree to:\n`}
                    </Text>

                    <View style={GlobalStyle.bulletContainer}>
                        {
                            Agreements.map((as: BulletProps) => (
                                <View key={as.id} style={GlobalStyle.bullets}>
                                    <View style={GlobalStyle.bullet} />
                                    <Text style={GlobalStyle.normalSize}>{as.label}</Text>
                                </View>
                ...
                <View style={GlobalStyle.sectionContainer}>
                    <Text style={GlobalStyle.section}>
                        <Text style={GlobalStyle.title}>Health Disclaimer</Text>
                        {`\n\nThe App and its content are provided for `}
                        <Text style={GlobalStyle.highlight}>
                ...
                <View style={GlobalStyle.sectionContainer}>
                    <Text style={GlobalStyle.section}>
                        <Text style={GlobalStyle.title}>App Usage and Restrictions</Text>
                        {`\n\nYou agree not to:\n`}
                    </Text>

                    <View style={GlobalStyle.bulletContainer}>
                        {
                            Restrictions.map((as: BulletProps) => (
                                <View key={as.id} style={GlobalStyle.bullets}>
                                    <View style={GlobalStyle.bullet} />
                                    <Text style={GlobalStyle.normalSize}>{as.label}</Text>
                                </View>
                ...
                <View style={GlobalStyle.sectionContainer}>
                    <Text style={GlobalStyle.section}>
                        <Text style={GlobalStyle.title}>Privacy</Text>
                        {`\n\nYour privacy is important to us.`}
                    </Text>

                    <Text style={GlobalStyle.section}>
                        Please review our <Text style={GlobalStyle.link} onPress={_onGoToPrivacyPolicy}>Privacy Policy</Text> to understand how we collect, use, and protect your personal information.
                    </Text>
                </View>

                {/* <View style={GlobalStyle.sectionContainer}>
                    <Text style={GlobalStyle.section}>
                        <Text style={GlobalStyle.title}>Subscription and Fees</Text>
...
Subscription terms, renewal, and cancellation details will be clearly presented in the App.`}
                ...
                <View style={GlobalStyle.sectionContainer}>
                    <Text style={GlobalStyle.section}>
                        <Text style={GlobalStyle.title}>Intellectual Property</Text>
...
You may not use our intellectual property without our written consent.`}
                ...
                <View style={GlobalStyle.sectionContainer}>
                    <Text style={GlobalStyle.section}>
                        <Text style={GlobalStyle.title}>Limitation of Liability</Text>
                        {`\n\nTo the fullest extent permitted by law, `}<Text style={GlobalStyle.highlight}>we are not liable</Text> for any direct, indirect, incidental, or consequential damages arising from your use or inability to use the App.{`\n\n`}Use of the App is at your own risk.
                    </Text>
                </View>

                <View style={GlobalStyle.sectionContainer}>
                    <Text style={GlobalStyle.section}>
                        <Text style={GlobalStyle.title}>Termination</Text>
                ...
                <View style={GlobalStyle.sectionContainer}>
                    <Text style={GlobalStyle.section}>
                        <Text style={GlobalStyle.title}>Changes to These Terms</Text>
                ...
                <View style={GlobalStyle.sectionContainer}>
                    <Text style={GlobalStyle.section}>
                        ...
                        {`\n\nIf you have questions or concerns about these Terms, please send us a message via our `}<Text style={GlobalStyle.link} onPress={_onContactUs}>Contact Us form.</Text>
                    </Text>
                </View>
            </ScrollView>
        </SafeAreaView>
